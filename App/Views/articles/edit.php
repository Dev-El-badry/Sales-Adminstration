	...
	<div class="add-page">
			...
			<!--	<div class="search-box">	
					<form>	
						...
						<button name="search-btn" id="search-btn" class="search-btn btn btn-success btn-lg">
		...
		<div class="form-add">
			<form method="post" action="" enctype="multipart/form-data" id="form-add">
				...
				<div class="o-side">
					...
					<div class="search-sup">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<p class="supplier_name_info">Supplier</p>
					...
					<div class="panel panel-primary">
						<div class="panel-heading"><span class="panel-title"><i class="fa fa-file-photo-o fa-lg"></i>  Item Image</span></div>
						<div class="panel-body">
						<!-- Default Image -->
							<img src="images/item.png" alt=""  class="img-thumbnail img-responsive">
							<?= $form->file('thumb', [
								'id' => 'thumb',
